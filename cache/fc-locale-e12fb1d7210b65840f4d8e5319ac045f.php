<?php return array (
  'context.current' => 'Jurnal:',
  'context.select' => 'Lihat jurnal lain:',
  ...
  'common.publishedSubmission' => 'Artikel',
  'common.publishedSubmissions' => 'Artikel',
  ...
  'admin.auth.defaultSourceDescription' => '<p>Menetapkan sumber otentikasi selain OJS akan menimbulkan dampak berikut:</p>
<ul>
...
<li>Setelah naskah berhasil di unggah, klik tombol Simpan dan Lanjutkan.</li>
  ...
  'submission.layout.publicGalleyId' => 'Indentifier Galley Publik',
...
<li>Gunakan tanda bintang (<strong>*</strong>) dalam istilah untuk menghasilkan semua urutan karakter; contoh: <em>soci*</em> morality akan cocok dengan dokumen yang berisi "sociological" atau "societal"</li>
  ...
  'current.noCurrentIssueDesc' => 'Jurnal ini belum mengeluarkan satu pun terbitan.',
  ...
  'about.authorSelfArchive' => 'Arsip Mandiri Penulis',
  ...
  'about.aboutOJSSite' => 'Situs ini menggunakan Open Journal Systems {$ojsVersion}, merupakan perangkat lunak open source untuk pengelolaan dan penerbitan jurnal yang dikembangkan, didukung, dan didistribusikan bebas oleh <a href="http://pkp.sfu.ca/">Public Knowledge Project</a> di bawah GNU General Public License.',
...
<ul>
	...
	<p>2. Buat direktori khusus untuk menyimpan file unggahan dan buat "writable" (lihat Pengaturan File di bawah ini)</p>',
...
Server Anda sekarang support mbstring: <strong>{$supportsMBString}</strong>',
  ...
  'installer.additionalLocalesInstructions' => 'Pilih bahasa-bahasa tambahan yang hendak didukung sistem ini.  Bahasa-bahasa ini akan dapat digunakan oleh jurnal-jurnal yang dikelola di sistem ini.  Bahasa tambahan dapat juga diinstal kapan saja dari antarmuka administrasi situs.',
...
<p>Installer tidak bisa secara otomatis menimpa file konfigurasi. Sebelum mencoba untuk menggunakan sistem, buka <tt>config.inc.php</tt> menggunakan text editor dan ganti isinya dengan isi kolom berikut ini.</p>',
  'installer.installationComplete' => '<p>Instalasi OJS telah berhasil.</p>
...
<p>Jika Anda belum terdaftar dan ingin menerima berita dan update, <strong>silakan daftar di <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> Jika Anda memiliki pertanyaan atau komentar, silakan kunjungi <a href="http://forum.pkp.sfu.ca" target="_new">forum dukungan</a>.</p>',
  'site.upgradeAvailable.admin' => 'Ada versi baru OJS! Anda saat ini menggunakan OJS {$currentVersion}. Versi terbaru adalah OJS {$latestVersion}. Silakan kunjungi <a href="http://pkp.sfu.ca/ojs_download" target="_new">laman ini</a> untuk mengunduh versi terbaru dan membaca instruksi upgrade-nya.',
  ...
  'log.review.reviewReinitiated' => 'Ronde {$round} review oleh {$reviewerName} untuk naskah {$submissionId} telah dimulai ulang.',
  ...
  'rt.admin.settings' => 'Pilihan Alat Baca',
  'rt.admin.settings.description' => 'Alat baca ditampilkan dalam bingkai di sebelah item yang sudah diterbitkan di bagian jurnal yang telah ditentukan untuk pengindeksan. Alat baca terdiri dari satu set alat terkait item yang diterbitkan, seperti daftar berikut, dan satu set alat yang memberikan akses ke item yang relevan, disusun berdasar bidang dan disiplin ilmu.',
  'rt.admin.settings.enableReadingTools' => 'Aktifkan Alat Baca di bagian jurnal yang telah ditentukan',
  'rt.admin.settings.relatedItems' => 'Bidang',
  'rt.admin.settings.relatedItemsLink' => 'Lihat <a href="{$relatedItemsLink}" class="action">Set Item Terkait</a> untuk melihat, tambah, koreksi, atau hapus item terkait untuk tiap bidang.',
  'rt.admin.options' => 'Alat Item Jurnal',
  'rt.admin.relatedItems' => 'Alat Item Terkait',
  'rt.admin.settings.addComment' => 'Tambah komentar (memungkinkan pembaca mengirim komentar, yang dapat dihapus oleh Manajer Jurnal).',
  'rt.admin.settings.addComment.authenticated' => 'Pengguna harus terdaftar dan login untuk dapat mengirim, tidak boleh anonim.',
  'rt.admin.settings.addComment.anonymous' => 'Pengguna harus terdaftar dan login untuk dapat mengirim, anonim diizinkan.',
  'rt.admin.settings.addComment.unauthenticated' => 'Pengguna tidak perlu terdaftar untuk dapat mengirim, anonim diizinkan.',
  'rt.admin.validateUrls.description' => 'Kemungkinan URL invalid ditampilkan berikut ini.<br/>
Anda harus memverifikasi manual semua URL yang ditandai invalid, karena tes ini tidak 100% akurat.<br/>
Validasi mungkin gagal pada URL yang mensyaratkan form data yang dikirimkan.',
  'rt.metadata.dublinCore.primaryAuthor' => 'Penulis',
  'rt.metadata.pkp.primaryAuthor' => 'Nama penulis, afiliasi, negara',
  'rt.metadata.pkp.peerReviewed' => 'Artikel Peer-review',
  'rt.beNotifiedWhen' => 'Diberitahu saat....',
  'rt.thisJournal' => 'Cari jurnal',
  'rt.context.authorTermsDescription' => 'Untuk item dengan lebih dari satu penulis, biarkan semua nama tercentang untuk mencari naskah yang ditulis bersama, atau cari satu per satu dengan mencentang hanya satu nama.  Untuk mempelajari lebih lanjut pustaka yang dicari, klik TENTANG.  Pustaka ini telah dipilih karena relevansinya dan status Open Access untuk seluruh atau sebagian isinya',
  ...
  'user.authorization.noContext' => 'Tidak ada jurnal yang sesuai!',
