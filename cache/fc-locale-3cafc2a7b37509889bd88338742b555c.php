<?php return array (
  ...
  'manager.payment.generalFeesDescription' => 'Keanggotaan Asosiasi akan ditampilkan di Tentang Jurnal di bawah kebijakan, dan tautan donasi akan muncul di atas fungsi cari di frame sebelah kanan.',
  ...
  'manager.sections.confirmDelete' => 'Apakah Anda yakin ingin menghapus bagian ini secara permanen? Setelah ini, Anda harus menerbitkan ulang semua artikel di bagian ini.',
  ...
  'manager.setup.editorialTeam.description' => 'Sebutkan editor, direktur pelaksana, dan pihak-pihak lain yang terkait dalam struktur organisasi pelaksana jurnal.',
  ...
  'manager.setup.layout' => 'Layout Jurnal',
  ...
  'manager.setup.announcementsDescription' => 'Pengumuman bisa diterbitkan untuk menginformasikan kepada pembaca tentang berita dan agenda jurnal. Pengumuman yang diterbitkan akan ditampilkan di halaman Pengumuman.',
  ...
  'manager.setup.copyrightNotice' => 'Pernyataan Hak Cipta',
  ...
  'manager.setup.emailBounceAddressDisabled' => '<strong>Catatan:</strong> Untuk mengaktifkan pilihan ini, administrator situs harus mengaktifkan pilihan <tt>allow_envelope_sender</tt> di file konfigurasi OJS. Konfigurasi server tambahan mungkin diperlukan untuk mendukung fungsi ini (tidak semua server bisa), seperti yang tercantum di dokumentasi OJS.',
  'manager.setup.emails' => 'Identifikasi Email',
  'manager.setup.emailSignature' => 'Tandatangan',
  'manager.setup.emailSignatureDescription' => 'Email yang disiapkan dan dikirim oleh sistem atas nama jurnal akan memiliki tandatangan berikut ini di akhir pesan.',
  'manager.setup.enableAnnouncements' => 'Memungkinkan manajer jurnal untuk menambahkan pengumuman jurnal.',
  'manager.setup.enableAnnouncementsHomepage1' => 'Tampilkan',
  ...
  'manager.setup.journalSummary' => 'Ringkasan Jurnal',
  'manager.setup.journalSummary.description' => 'Deskripsi singkat tentang jurnal Anda untuk ditampilkan di daftar jurnal.',
  'manager.setup.journalAbout' => 'Tentang Jurnal',
  'manager.setup.journalAbout.description' => 'Tuliskan semua informasi tentang jurnal Anda yang mungkin bermanfaat bagi pembaca, penulis atau reviewer. Hal ini dapat mencakup kebijakan Open Access, fokus dan lingkup jurnal, pernyataan hak cipta, pernyataan sponsorship, sejarah jurnal, pernyataan privasi, dan keterlibatan di sistem pengarsipan LOCKSS maupun CLOCKSS.',
  'manager.setup.favicon' => 'Favicon Jurnal',
  'manager.setup.faviconDescription' => 'Tambahkan favicon untuk jurnal ini untuk ditampilkan bersama bilah navigasi ketika pengguna mengunjungi website Anda.',
  'manager.setup.faviconInvalid' => 'Format favicon invalid. Format yang diterima adalah .ico, .png, dan .gif.',
  ...
  'manager.setup.journalThumbnail.altText' => 'Teks pengganti untuk thumbnail',
  ...
  'manager.setup.layoutTemplatesDescription' => 'Template dapat diunggah untuk ditampilkan di layout pada masing-masing format standar yang diterbitkan di jurnal (contoh: artikel, review buku, dll) menggunakan format file apapun (contoh: pdf, doc, dll) dengan catatan yang ditambahkan jenis huruf, ukuran margin, dll sebagai petunjuk untuk Layout Editor dan Proofreader.',
  'manager.setup.layoutTemplates.file' => 'File Template',
  'manager.setup.layoutTemplates.title' => 'Judul',
  'manager.setup.lists' => 'Daftar',
  'manager.setup.listsDescription' => 'Batasi jumlah item (sebagai contoh: penyerahan, pengguna, atau tugas pengeditan) yang ditampilkan dalam sebuah daftar sebelum menampilkan item berikutnya di halaman lain.  Juga untuk membatasi jumlah tautan yang ditampilkan di halaman berikutnya.',
  'manager.setup.enableArchive' => 'Aktifkan Pengarsipan',
  ...
  'manager.setup.clockssEnable' => 'Aktifkan CLOCKSS untuk menyimpan dan mendistribusikan konten jurnal ke perpustakaan yang berpartisipasi melalui halaman <a href="{$clockssUrl}" target="_blank">Publisher Manifest</a> CLOCKSS',
  ...
  'manager.setup.notifications.submissionAckDisabled' => '<strong>Catatan:</strong> Email pemberitahuan penyerahan saat ini tidak diaktifkan. Untuk menggunakan fitur ini, aktifkan email SUBMISSION_ACK di menu Email</a>.',
  ...
  'manager.setup.openAccess' => 'Jurnal akan mendukung Open Access untuk konten jurnal.',
  ...
  'manager.setup.provideRefLinkInstructions' => 'Berikan petunjuk bagi Layout Editor.',
  ...
  'manager.setup.publisherDescription' => 'Nama organisasi yang menerbitkan jurnal dapat disertakan dalam metadata yang diberikan ke badan pengarsipan luar.',
  ...
  'manager.setup.reviewGuidelinesDescription' => 'Memberi panduan bagi Reviewer tentang kriteria untuk menilai kelayakan naskah yang akan diterbitkan di jurnal, dapat berisi instruksi untuk menyiapkan review yang efektif dan berguna. Reviewer berkesempatan untuk memberikan komentar untuk penulis dan editor, dan juga komentar yang khusus untuk editor saja.',
  ...
  'manager.setup.reviewOptions.blindReview' => 'Review Anonim',
  ...
  'manager.setup.subscriptionDescription' => 'Menugaskan seorang Manajer Langganan yang memiliki akses ke modul langganan, yang termasuk akses terbuka tambahan, pengarsipan mandiri, dan notifikasi email.',
  'manager.setup.noPublishing' => 'OJS tidak akan digunakan untuk menerbitkan konten jurnal secara online.',
  ...
  'manager.setup.useJournalStyleSheet' => 'Stylesheet jurnal',
  ...
  'manager.subscriptionPolicies.authorSelfArchive' => 'Kebijakan Pengarsipan Mandiri Penulis',
  'manager.subscriptionPolicies.authorSelfArchiveDescription' => 'Kebijakan pengarsipan mandiri penulis berikut ini akan ditampilkan di Tentang Jurnal di bawah Kebijakan.',
  'manager.subscriptionPolicies.delayedOpenAccess' => 'Delayed Open Access',
  'manager.subscriptionPolicies.delayedOpenAccessDescription' => 'Dengan Delayed Open Access, editor masih bisa mengangkat artikel spesifik dalam sebuah terbitan untuk langsung dijadikan Open Access.',
  'manager.subscriptionPolicies.delayedOpenAccessDescription1' => 'Terbitan terdahulu jurnal ini akan menjadi Open Access',
  'manager.subscriptionPolicies.delayedOpenAccessDescription2' => 'bulan setelah terbitan diterbitkan.',
  'manager.subscriptionPolicies.delayedOpenAccessDurationValid' => 'Pilih panjang durasi yang valid.',
  'manager.subscriptionPolicies.delayedOpenAccessPolicyDescription' => 'Kebijakan Delayed Open Access berikut ini akan ditampilkan di Tentang Jurnal di bawah Kebijakan.',
  ...
  'manager.setup.resetPermissions.confirm' => 'Anda yakin hendak melakukan reset permission untuk data yang telah melekat di artikel?',
